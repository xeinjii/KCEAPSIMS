...
<div style="justify-content: center; display: flex; align-items: center; flex-direction: column;">
  ...
  <div class="side-bar">
    <ul>
      <li><a href="profile.php"><span class="material-symbols-outlined icons">person</span>Profile</a></li>
      <hr>
      <li><a href="mainpage.php"><span class="material-symbols-outlined icons">description</span>Form</a></li>
      <hr>
      <li>
