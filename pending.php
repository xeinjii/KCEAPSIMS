...
$query4 = "SELECT * FROM renew_hs_pending";
$result4 = mysqli_query($conn, $query4);
$rows3 = mysqli_fetch_all($result4, MYSQLI_ASSOC);
?>
...
<body>
    ...
    <div class="pending-container">
        ...
        <div class="pending-row">
            ...
            <a class="card" href="#" data-bs-toggle="modal" data-bs-target="#highschoolRenewModal">
                ...
                <p>TOTAL: <?php echo mysqli_num_rows($result4); ?></p>
                <span class="material-symbols-outlined">pending_actions</span>
            </a>
        </div>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($row['income']); ?>"
                                    target="_blank">
                                    Income Proof
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($row['birthcert']); ?>"
                                    target="_blank">
                                    Birth Certificate
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($row['comelec']); ?>"
                                    target="_blank">
                                    COMELEC Certificate
                                </a>
                            </li>
                            ...
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($row['moral']); ?>"
                                    target="_blank">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control border-danger" id="rejection_message<?php echo $row['id']; ?>"
                                    name="rejection_message" rows="4" placeholder="Provide a reason for rejection..."
                                    required></textarea>
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-between">
    ...
    <div class="modal fade" id="collegeRenewModal" tabindex="-1" aria-labelledby="collegeRenewModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
    ...
    <?php foreach ($renewRows as $renewRow): ?>
        <div class="modal fade" id="viewRenewDetailsModal<?php echo $renewRow['id']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="viewRenewDetailsModalLabel<?php echo $renewRow['id']; ?>">Renewal
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Submitted At:</strong> <?php echo htmlspecialchars($renewRow['submitted_at']); ?>
                                </p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($renewRow['comelec_certificate']); ?>"
                                    target="_blank">
                                    COMELEC Certificate
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($renewRow['grades']); ?>"
                                    target="_blank">
                                    Complete Grades
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./College_documents/<?php echo htmlspecialchars($renewRow['enrollment_certificate']); ?>"
                                    target="_blank">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control border-danger"
                                    id="rejection_message<?php echo $renewRow['id']; ?>" name="rejection_message" rows="4"
    ...
    <div class="modal fade" id="highschoolPendingModal" tabindex="-1" aria-labelledby="highschoolPendingModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
    ...
    <?php foreach ($hsRows as $hsRow): ?>
        <div class="modal fade" id="viewHSDetailsModal<?php echo $hsRow['id']; ?>" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="viewHSDetailsModalLabel<?php echo $hsRow['id']; ?>">Application Details
                        </h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><strong>Submitted At:</strong> <?php echo htmlspecialchars($hsRow['submitted_at']); ?>
                                </p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <a href="./HS_documents/<?php echo htmlspecialchars($hsRow['birthcert']); ?>"
                                    target="_blank">
                                    Birth Certificate
                                </a>
                            </li>
                    ...
                    <form method="POST" action="hsprocessapplication.php">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control border-danger"
                                    id="rejection_message<?php echo $hsRow['id']; ?>" name="rejection_message" rows="4"
                                    placeholder="Provide a reason for rejection..." required></textarea>
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-between">
   ...
   <div class="modal fade" id="highschoolRenewModal" tabindex="-1" aria-labelledby="highschoolRenewModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="highschoolRenewModalLabel">Highschool Renew Pending Applications</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover align-middle text-center">
                            ...
                            <tbody>
                                <?php
                                // Fetch highschool renew pending data
                                $hsRenewQuery = "SELECT * FROM renew_hs_pending";
                                $hsRenewResult = mysqli_query($conn, $hsRenewQuery);
                                $hsRenewRows = mysqli_fetch_all($hsRenewResult, MYSQLI_ASSOC);

                                foreach ($hsRenewRows as $hsRenewRow): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($hsRenewRow['name']); ?></td>
                                        <td><?php echo htmlspecialchars($hsRenewRow['submitted_at']); ?></td>
                                        <td>
                                            <button class="btn btn-outline-info btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#viewHsRenewDetailsModal<?php echo $hsRenewRow['id']; ?>">View</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
    ...
    <!-- View Highschool Renew Details Modals -->
    <?php foreach ($hsRenewRows as $hsRenewRow): ?>
        <div class="modal fade" id="viewHsRenewDetailsModal<?php echo $hsRenewRow['id']; ?>" tabindex="-1"
            aria-labelledby="viewHsRenewDetailsModalLabel<?php echo $hsRenewRow['id']; ?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="viewHsRenewDetailsModalLabel<?php echo $hsRenewRow['id']; ?>">Renewal
                            Application Details</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <?php
                                // Fetch the name from the hsrecords table using the id in the name field of renew_hs_pending
                                $recordId = $hsRenewRow['name'];
                                $recordQuery = "SELECT name FROM hsrecords WHERE id = ?";
                                $stmt = $conn->prepare($recordQuery);
                                $stmt->bind_param("i", $recordId);
                                $stmt->execute();
                                $recordResult = $stmt->get_result();
                                ...
                                ?>
                                <p><strong>Name:</strong> <?php echo htmlspecialchars($record['name']); ?></p>
                                <p><strong>Semester:</strong> <?php echo htmlspecialchars($hsRenewRow['semester']); ?></p>
                                <p><strong>Submitted At:</strong> <?php echo htmlspecialchars($hsRenewRow['submitted_at']); ?></p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Renewal ID:</strong> <?php echo htmlspecialchars($hsRenewRow['id']); ?></p>
                            </div>
                        </div>
                        <hr>
                        <p><strong>Documents:</strong></p>
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a href="./Hs_documents/<?php echo htmlspecialchars($hsRenewRow['comelec']); ?>"
                                    target="_blank">
                                    COMELEC Certificate
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./Hs_documents/<?php echo htmlspecialchars($hsRenewRow['grades']); ?>"
                                    target="_blank">
                                    Complete Grades
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="./Hs_documents/<?php echo htmlspecialchars($hsRenewRow['enrollment']); ?>"
                                    target="_blank">
                                    Enrollment Certificate
                                </a>
                            </li>
                    ...
                    <div class="modal-footer">
                        <form method="POST" action="hsrenewprocess.php" class="w-100 d-flex gap-2">
                            <input type="hidden" name="application_id" value="<?php echo $hsRenewRow['id']; ?>">
                            <button type="submit" name="accept" class="btn btn-success flex-grow-1">Accept</button>
                            <button type="button" class="btn btn-danger flex-grow-1" data-bs-toggle="modal"
                                data-bs-target="#rejectHsRenewModal<?php echo $hsRenewRow['id']; ?>">Reject</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <!-- Reject Modal for Highschool Renew -->
        <div class="modal fade" id="rejectHsRenewModal<?php echo $hsRenewRow['id']; ?>" tabindex="-1"
            aria-labelledby="rejectHsRenewModalLabel<?php echo $hsRenewRow['id']; ?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="rejectHsRenewModalLabel<?php echo $hsRenewRow['id']; ?>">
                            <i class="bi bi-x-circle-fill"></i> Reject Application
                        </h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form method="POST" action="hsrenewprocess.php">
                        <div class="modal-body">
                            <input type="hidden" name="application_id" value="<?php echo $hsRenewRow['id']; ?>">
                            <div class="mb-3">
                                <label for="rejection_message<?php echo $hsRenewRow['id']; ?>" class="form-label">
                                    <strong>Rejection Message</strong>
                                </label>
                                <textarea class="form-control border-danger" id="rejection_message<?php echo $hsRenewRow['id']; ?>"
                                    name="rejection_message" rows="4" placeholder="Provide a reason for rejection..."
                                    required></textarea>
                            </div>
                        </div>
